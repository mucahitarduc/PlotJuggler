...
static void mavlink_test_gcs_to_mcu_select_target(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_SELECT_TARGET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_select_target_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0
    };
    mavlink_gcs_to_mcu_select_target_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.selection_time = packet_in.selection_time;
        packet1.center_x_ratio = packet_in.center_x_ratio;
        packet1.center_y_ratio = packet_in.center_y_ratio;
        packet1.width_ratio = packet_in.width_ratio;
        packet1.height_ratio = packet_in.height_ratio;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_SELECT_TARGET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_SELECT_TARGET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_select_target_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_select_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_select_target_pack(system_id, component_id, &msg , packet1.center_x_ratio , packet1.center_y_ratio , packet1.width_ratio , packet1.height_ratio , packet1.selection_time );
    mavlink_msg_gcs_to_mcu_select_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_select_target_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.center_x_ratio , packet1.center_y_ratio , packet1.width_ratio , packet1.height_ratio , packet1.selection_time );
    mavlink_msg_gcs_to_mcu_select_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_select_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_select_target_send(MAVLINK_COMM_1 , packet1.center_x_ratio , packet1.center_y_ratio , packet1.width_ratio , packet1.height_ratio , packet1.selection_time );
    mavlink_msg_gcs_to_mcu_select_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vision_operating_mode_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VISION_OPERATING_MODE_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_vision_operating_mode_info_t packet_in = {
        963497464
    };
    mavlink_vision_operating_mode_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VISION_OPERATING_MODE_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VISION_OPERATING_MODE_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vision_operating_mode_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_vision_operating_mode_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vision_operating_mode_info_pack(system_id, component_id, &msg , packet1.operating_mode );
    mavlink_msg_vision_operating_mode_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vision_operating_mode_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.operating_mode );
    mavlink_msg_vision_operating_mode_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_vision_operating_mode_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vision_operating_mode_info_send(MAVLINK_COMM_1 , packet1.operating_mode );
    mavlink_msg_vision_operating_mode_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_zoom_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_ZOOM_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_zoom_control_t packet_in = {
        17.0
    };
    mavlink_gcs_to_mcu_zoom_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.requested_zoom_delta = packet_in.requested_zoom_delta;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_ZOOM_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_ZOOM_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_zoom_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_zoom_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_zoom_control_pack(system_id, component_id, &msg , packet1.requested_zoom_delta );
    mavlink_msg_gcs_to_mcu_zoom_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_zoom_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.requested_zoom_delta );
    mavlink_msg_gcs_to_mcu_zoom_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_zoom_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_zoom_control_send(MAVLINK_COMM_1 , packet1.requested_zoom_delta );
    mavlink_msg_gcs_to_mcu_zoom_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_gimbal_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_gimbal_control_t packet_in = {
        17.0,45.0,73.0
    };
    mavlink_gcs_to_mcu_gimbal_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.requested_pitch_delta = packet_in.requested_pitch_delta;
        packet1.requested_roll_delta = packet_in.requested_roll_delta;
        packet1.requested_yaw_delta = packet_in.requested_yaw_delta;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_gimbal_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_control_pack(system_id, component_id, &msg , packet1.requested_pitch_delta , packet1.requested_roll_delta , packet1.requested_yaw_delta );
    mavlink_msg_gcs_to_mcu_gimbal_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.requested_pitch_delta , packet1.requested_roll_delta , packet1.requested_yaw_delta );
    mavlink_msg_gcs_to_mcu_gimbal_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_gimbal_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_control_send(MAVLINK_COMM_1 , packet1.requested_pitch_delta , packet1.requested_roll_delta , packet1.requested_yaw_delta );
    mavlink_msg_gcs_to_mcu_gimbal_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_to_gcs_pod_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_TO_GCS_POD_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_to_gcs_pod_status_t packet_in = {
        17.0,45.0,73.0,101.0,53
    };
    mavlink_mcu_to_gcs_pod_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.current_zoom_level = packet_in.current_zoom_level;
        packet1.current_pitch = packet_in.current_pitch;
        packet1.current_roll = packet_in.current_roll;
        packet1.current_yaw = packet_in.current_yaw;
        packet1.current_camera = packet_in.current_camera;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_TO_GCS_POD_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_TO_GCS_POD_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_pod_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_to_gcs_pod_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_pod_status_pack(system_id, component_id, &msg , packet1.current_zoom_level , packet1.current_pitch , packet1.current_roll , packet1.current_yaw , packet1.current_camera );
    mavlink_msg_mcu_to_gcs_pod_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_pod_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.current_zoom_level , packet1.current_pitch , packet1.current_roll , packet1.current_yaw , packet1.current_camera );
    mavlink_msg_mcu_to_gcs_pod_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_to_gcs_pod_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_pod_status_send(MAVLINK_COMM_1 , packet1.current_zoom_level , packet1.current_pitch , packet1.current_roll , packet1.current_yaw , packet1.current_camera );
    mavlink_msg_mcu_to_gcs_pod_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_steer_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_STEER_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_steer_control_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_gcs_to_mcu_steer_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.thrust_value = packet_in.thrust_value;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_STEER_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_STEER_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_steer_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_steer_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_steer_control_pack(system_id, component_id, &msg , packet1.thrust_value , packet1.pitch_value , packet1.roll_value , packet1.yaw_value );
    mavlink_msg_gcs_to_mcu_steer_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_steer_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.thrust_value , packet1.pitch_value , packet1.roll_value , packet1.yaw_value );
    mavlink_msg_gcs_to_mcu_steer_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_steer_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_steer_control_send(MAVLINK_COMM_1 , packet1.thrust_value , packet1.pitch_value , packet1.roll_value , packet1.yaw_value );
    mavlink_msg_gcs_to_mcu_steer_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_COMMAND >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_command_t packet_in = {
        963497464,963497672
    };
    mavlink_gcs_to_mcu_command_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_COMMAND_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_COMMAND_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_command_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_command_pack(system_id, component_id, &msg , packet1.command_type , packet1.param );
    mavlink_msg_gcs_to_mcu_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.command_type , packet1.param );
    mavlink_msg_gcs_to_mcu_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_command_send(MAVLINK_COMM_1 , packet1.command_type , packet1.param );
    mavlink_msg_gcs_to_mcu_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_to_gcs_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_TO_GCS_HEARTBEAT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_to_gcs_heartbeat_t packet_in = {
        963497464,963497672,963497880,963498088,963498296
    };
    mavlink_mcu_to_gcs_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.status = packet_in.status;
        packet1.error_code = packet_in.error_code;
        packet1.emergency_code = packet_in.emergency_code;
        packet1.flight_time = packet_in.flight_time;
        packet1.sensor_health = packet_in.sensor_health;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_TO_GCS_HEARTBEAT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_TO_GCS_HEARTBEAT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_heartbeat_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_to_gcs_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_heartbeat_pack(system_id, component_id, &msg , packet1.status , packet1.error_code , packet1.emergency_code , packet1.flight_time , packet1.sensor_health );
    mavlink_msg_mcu_to_gcs_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.status , packet1.error_code , packet1.emergency_code , packet1.flight_time , packet1.sensor_health );
    mavlink_msg_mcu_to_gcs_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_to_gcs_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_heartbeat_send(MAVLINK_COMM_1 , packet1.status , packet1.error_code , packet1.emergency_code , packet1.flight_time , packet1.sensor_health );
    mavlink_msg_mcu_to_gcs_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_add_update_waypoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ADD_UPDATE_WAYPOINT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_add_update_waypoint_t packet_in = {
        963497464,963497672,963497880,17859,17963,18067,18171,18275,18379,18483,18587,18691,223
    };
    mavlink_add_update_waypoint_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.latitude = packet_in.latitude;
        packet1.longitude = packet_in.longitude;
        packet1.altitude = packet_in.altitude;
        packet1.wp_id = packet_in.wp_id;
        packet1.prev_wp_id = packet_in.prev_wp_id;
        packet1.next_wp_id = packet_in.next_wp_id;
        packet1.navigation_speed = packet_in.navigation_speed;
        packet1.action_wait_time = packet_in.action_wait_time;
        packet1.action_activate_camera = packet_in.action_activate_camera;
        packet1.action_zoom_control = packet_in.action_zoom_control;
        packet1.action_gimbal_pitch = packet_in.action_gimbal_pitch;
        packet1.action_gimbal_yaw = packet_in.action_gimbal_yaw;
        packet1.type = packet_in.type;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ADD_UPDATE_WAYPOINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ADD_UPDATE_WAYPOINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_update_waypoint_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_add_update_waypoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_update_waypoint_pack(system_id, component_id, &msg , packet1.latitude , packet1.longitude , packet1.altitude , packet1.type , packet1.wp_id , packet1.prev_wp_id , packet1.next_wp_id , packet1.navigation_speed , packet1.action_wait_time , packet1.action_activate_camera , packet1.action_zoom_control , packet1.action_gimbal_pitch , packet1.action_gimbal_yaw );
    mavlink_msg_add_update_waypoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_update_waypoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.latitude , packet1.longitude , packet1.altitude , packet1.type , packet1.wp_id , packet1.prev_wp_id , packet1.next_wp_id , packet1.navigation_speed , packet1.action_wait_time , packet1.action_activate_camera , packet1.action_zoom_control , packet1.action_gimbal_pitch , packet1.action_gimbal_yaw );
    mavlink_msg_add_update_waypoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_add_update_waypoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_update_waypoint_send(MAVLINK_COMM_1 , packet1.latitude , packet1.longitude , packet1.altitude , packet1.type , packet1.wp_id , packet1.prev_wp_id , packet1.next_wp_id , packet1.navigation_speed , packet1.action_wait_time , packet1.action_activate_camera , packet1.action_zoom_control , packet1.action_gimbal_pitch , packet1.action_gimbal_yaw );
    mavlink_msg_add_update_waypoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_waypoint_update(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_WAYPOINT_UPDATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_waypoint_update_t packet_in = {
        17235,17339,17443
    };
    mavlink_waypoint_update_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.current_wp_id = packet_in.current_wp_id;
        packet1.dest_wp_id = packet_in.dest_wp_id;
        packet1.lap = packet_in.lap;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_WAYPOINT_UPDATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_WAYPOINT_UPDATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_update_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_waypoint_update_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_update_pack(system_id, component_id, &msg , packet1.current_wp_id , packet1.dest_wp_id , packet1.lap );
    mavlink_msg_waypoint_update_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_update_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.current_wp_id , packet1.dest_wp_id , packet1.lap );
    mavlink_msg_waypoint_update_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_waypoint_update_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_update_send(MAVLINK_COMM_1 , packet1.current_wp_id , packet1.dest_wp_id , packet1.lap );
    mavlink_msg_waypoint_update_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_go_to_location(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_GO_TO_LOCATION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_go_to_location_t packet_in = {
        963497464,963497672,963497880,963498088
    };
    mavlink_gcs_to_mcu_go_to_location_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.latitude = packet_in.latitude;
        packet1.longitude = packet_in.longitude;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_GO_TO_LOCATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_GO_TO_LOCATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_go_to_location_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_go_to_location_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_go_to_location_pack(system_id, component_id, &msg , packet1.latitude , packet1.longitude , packet1.home_latitude , packet1.home_longitude );
    mavlink_msg_gcs_to_mcu_go_to_location_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_go_to_location_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.latitude , packet1.longitude , packet1.home_latitude , packet1.home_longitude );
    mavlink_msg_gcs_to_mcu_go_to_location_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_go_to_location_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_go_to_location_send(MAVLINK_COMM_1 , packet1.latitude , packet1.longitude , packet1.home_latitude , packet1.home_longitude );
    mavlink_msg_gcs_to_mcu_go_to_location_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_as5048a_magnetic_rotary_encoder(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AS5048A_MAGNETIC_ROTARY_ENCODER >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_as5048a_magnetic_rotary_encoder_t packet_in = {
        { 17.0, 18.0, 19.0 }
    };
    mavlink_as5048a_magnetic_rotary_encoder_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AS5048A_MAGNETIC_ROTARY_ENCODER_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AS5048A_MAGNETIC_ROTARY_ENCODER_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_as5048a_magnetic_rotary_encoder_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_as5048a_magnetic_rotary_encoder_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_as5048a_magnetic_rotary_encoder_pack(system_id, component_id, &msg , packet1.angle );
    mavlink_msg_as5048a_magnetic_rotary_encoder_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_as5048a_magnetic_rotary_encoder_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.angle );
    mavlink_msg_as5048a_magnetic_rotary_encoder_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_as5048a_magnetic_rotary_encoder_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_as5048a_magnetic_rotary_encoder_send(MAVLINK_COMM_1 , packet1.angle );
    mavlink_msg_as5048a_magnetic_rotary_encoder_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_to_ap_system_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_TO_AP_SYSTEM_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_to_ap_system_status_t packet_in = {
        963497464
    };
    mavlink_mcu_to_ap_system_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.system_status = packet_in.system_status;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_TO_AP_SYSTEM_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_TO_AP_SYSTEM_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_ap_system_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_to_ap_system_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_ap_system_status_pack(system_id, component_id, &msg , packet1.system_status );
    mavlink_msg_mcu_to_ap_system_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_ap_system_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.system_status );
    mavlink_msg_mcu_to_ap_system_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_to_ap_system_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_ap_system_status_send(MAVLINK_COMM_1 , packet1.system_status );
    mavlink_msg_mcu_to_ap_system_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ap_to_mcu_emergency_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AP_TO_MCU_EMERGENCY_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_ap_to_mcu_emergency_status_t packet_in = {
        963497464,963497672,963497880
    };
    mavlink_ap_to_mcu_emergency_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AP_TO_MCU_EMERGENCY_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AP_TO_MCU_EMERGENCY_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_to_mcu_emergency_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_ap_to_mcu_emergency_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_to_mcu_emergency_status_pack(system_id, component_id, &msg , packet1.reason , packet1.action , packet1.sensor_health );
    mavlink_msg_ap_to_mcu_emergency_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_to_mcu_emergency_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.reason , packet1.action , packet1.sensor_health );
    mavlink_msg_ap_to_mcu_emergency_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ap_to_mcu_emergency_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_to_mcu_emergency_status_send(MAVLINK_COMM_1 , packet1.reason , packet1.action , packet1.sensor_health );
    mavlink_msg_ap_to_mcu_emergency_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_start_mission_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_START_MISSION_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_start_mission_status_t packet_in = {
        17235,17339
    };
    mavlink_mcu_start_mission_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.mode = packet_in.mode;
        packet1.status = packet_in.status;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_START_MISSION_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_START_MISSION_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_start_mission_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_start_mission_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_start_mission_status_pack(system_id, component_id, &msg , packet1.mode , packet1.status );
    mavlink_msg_mcu_start_mission_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_start_mission_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mode , packet1.status );
    mavlink_msg_mcu_start_mission_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_start_mission_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_start_mission_status_send(MAVLINK_COMM_1 , packet1.mode , packet1.status );
    mavlink_msg_mcu_start_mission_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_update_mission_plan_params(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_UPDATE_MISSION_PLAN_PARAMS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_update_mission_plan_params_t packet_in = {
        17235
    };
    mavlink_update_mission_plan_params_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lap_count = packet_in.lap_count;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_UPDATE_MISSION_PLAN_PARAMS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_UPDATE_MISSION_PLAN_PARAMS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_update_mission_plan_params_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_update_mission_plan_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_update_mission_plan_params_pack(system_id, component_id, &msg , packet1.lap_count );
    mavlink_msg_update_mission_plan_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_update_mission_plan_params_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lap_count );
    mavlink_msg_update_mission_plan_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_update_mission_plan_params_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_update_mission_plan_params_send(MAVLINK_COMM_1 , packet1.lap_count );
    mavlink_msg_update_mission_plan_params_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_vision_function_enabled(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SET_VISION_FUNCTION_ENABLED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_set_vision_function_enabled_t packet_in = {
        963497464,963497672,29
    };
    mavlink_set_vision_function_enabled_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.vision_function = packet_in.vision_function;
        packet1.function_param = packet_in.function_param;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SET_VISION_FUNCTION_ENABLED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SET_VISION_FUNCTION_ENABLED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_vision_function_enabled_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_set_vision_function_enabled_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_vision_function_enabled_pack(system_id, component_id, &msg , packet1.enable , packet1.vision_function , packet1.function_param );
    mavlink_msg_set_vision_function_enabled_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_vision_function_enabled_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.enable , packet1.vision_function , packet1.function_param );
    mavlink_msg_set_vision_function_enabled_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_set_vision_function_enabled_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_vision_function_enabled_send(MAVLINK_COMM_1 , packet1.enable , packet1.vision_function , packet1.function_param );
    mavlink_msg_set_vision_function_enabled_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_start_update_platform_shift(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_START_UPDATE_PLATFORM_SHIFT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_start_update_platform_shift_t packet_in = {
        963497464,963497672,963497880,963498088,129.0,157.0,185.0,213.0,18899
    };
    mavlink_start_update_platform_shift_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pri_latitude = packet_in.pri_latitude;
        packet1.pri_longitude = packet_in.pri_longitude;
        packet1.pri_altitude = packet_in.pri_altitude;
        packet1.pri_takeoffAltitude = packet_in.pri_takeoffAltitude;
        packet1.pri_yaw = packet_in.pri_yaw;
        packet1.pri_zoom_level = packet_in.pri_zoom_level;
        packet1.pri_gimbal_pitch = packet_in.pri_gimbal_pitch;
        packet1.pri_gimbal_yaw = packet_in.pri_gimbal_yaw;
        packet1.dest_wp_id = packet_in.dest_wp_id;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_START_UPDATE_PLATFORM_SHIFT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_START_UPDATE_PLATFORM_SHIFT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_start_update_platform_shift_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_start_update_platform_shift_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_start_update_platform_shift_pack(system_id, component_id, &msg , packet1.pri_latitude , packet1.pri_longitude , packet1.pri_altitude , packet1.pri_takeoffAltitude , packet1.pri_yaw , packet1.pri_zoom_level , packet1.pri_gimbal_pitch , packet1.pri_gimbal_yaw , packet1.dest_wp_id );
    mavlink_msg_start_update_platform_shift_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_start_update_platform_shift_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pri_latitude , packet1.pri_longitude , packet1.pri_altitude , packet1.pri_takeoffAltitude , packet1.pri_yaw , packet1.pri_zoom_level , packet1.pri_gimbal_pitch , packet1.pri_gimbal_yaw , packet1.dest_wp_id );
    mavlink_msg_start_update_platform_shift_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_start_update_platform_shift_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_start_update_platform_shift_send(MAVLINK_COMM_1 , packet1.pri_latitude , packet1.pri_longitude , packet1.pri_altitude , packet1.pri_takeoffAltitude , packet1.pri_yaw , packet1.pri_zoom_level , packet1.pri_gimbal_pitch , packet1.pri_gimbal_yaw , packet1.dest_wp_id );
    mavlink_msg_start_update_platform_shift_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_save_update_image(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SAVE_UPDATE_IMAGE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_save_update_image_t packet_in = {
        "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDE"
    };
    mavlink_save_update_image_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        mav_array_memcpy(packet1.image_name, packet_in.image_name, sizeof(char)*32);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SAVE_UPDATE_IMAGE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SAVE_UPDATE_IMAGE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_save_update_image_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_save_update_image_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_save_update_image_pack(system_id, component_id, &msg , packet1.image_name );
    mavlink_msg_save_update_image_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_save_update_image_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.image_name );
    mavlink_msg_save_update_image_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_save_update_image_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_save_update_image_send(MAVLINK_COMM_1 , packet1.image_name );
    mavlink_msg_save_update_image_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_to_mcu_gimbal_motor_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_MOTOR_COMMAND >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_to_mcu_gimbal_motor_command_t packet_in = {
        963497464
    };
    mavlink_gcs_to_mcu_gimbal_motor_command_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_MOTOR_COMMAND_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_TO_MCU_GIMBAL_MOTOR_COMMAND_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_pack(system_id, component_id, &msg , packet1.cmd );
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cmd );
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_send(MAVLINK_COMM_1 , packet1.cmd );
    mavlink_msg_gcs_to_mcu_gimbal_motor_command_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gcs_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GCS_POSITION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gcs_position_t packet_in = {
        963497464,963497672,29
    };
    mavlink_gcs_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gcs_latitude = packet_in.gcs_latitude;
        packet1.gcs_longitude = packet_in.gcs_longitude;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GCS_POSITION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GCS_POSITION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_position_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gcs_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_position_pack(system_id, component_id, &msg , packet1.gcs_latitude , packet1.gcs_longitude , packet1.is_valid );
    mavlink_msg_gcs_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gcs_latitude , packet1.gcs_longitude , packet1.is_valid );
    mavlink_msg_gcs_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gcs_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gcs_position_send(MAVLINK_COMM_1 , packet1.gcs_latitude , packet1.gcs_longitude , packet1.is_valid );
    mavlink_msg_gcs_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_other_platform_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OTHER_PLATFORM_POSITION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_other_platform_position_t packet_in = {
        963497464,963497672,963497880
    };
    mavlink_other_platform_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.latitude = packet_in.latitude;
        packet1.longitude = packet_in.longitude;
        packet1.altitude = packet_in.altitude;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OTHER_PLATFORM_POSITION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OTHER_PLATFORM_POSITION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_other_platform_position_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_other_platform_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_other_platform_position_pack(system_id, component_id, &msg , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_other_platform_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_other_platform_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_other_platform_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_other_platform_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_other_platform_position_send(MAVLINK_COMM_1 , packet1.latitude , packet1.longitude , packet1.altitude );
    mavlink_msg_other_platform_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_to_gcs_command_error(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_TO_GCS_COMMAND_ERROR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_to_gcs_command_error_t packet_in = {
        963497464,963497672
    };
    mavlink_mcu_to_gcs_command_error_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.error_code = packet_in.error_code;
        packet1.error_action = packet_in.error_action;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_TO_GCS_COMMAND_ERROR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_TO_GCS_COMMAND_ERROR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_command_error_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_to_gcs_command_error_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_command_error_pack(system_id, component_id, &msg , packet1.error_code , packet1.error_action );
    mavlink_msg_mcu_to_gcs_command_error_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_command_error_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.error_code , packet1.error_action );
    mavlink_msg_mcu_to_gcs_command_error_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_to_gcs_command_error_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_to_gcs_command_error_send(MAVLINK_COMM_1 , packet1.error_code , packet1.error_action );
    mavlink_msg_mcu_to_gcs_command_error_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_add_flight_point(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ADD_FLIGHT_POINT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_add_flight_point_t packet_in = {
        17.0,45.0,963497880,963498088
    };
    mavlink_add_flight_point_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.x = packet_in.x;
        packet1.y = packet_in.y;
        packet1.id = packet_in.id;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ADD_FLIGHT_POINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ADD_FLIGHT_POINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_flight_point_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_add_flight_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_flight_point_pack(system_id, component_id, &msg , packet1.x , packet1.y , packet1.id , packet1.type );
    mavlink_msg_add_flight_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_flight_point_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x , packet1.y , packet1.id , packet1.type );
    mavlink_msg_add_flight_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_add_flight_point_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_add_flight_point_send(MAVLINK_COMM_1 , packet1.x , packet1.y , packet1.id , packet1.type );
    mavlink_msg_add_flight_point_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_kflow_horizontal_motion(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_KFLOW_HORIZONTAL_MOTION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_kflow_horizontal_motion_t packet_in = {
        17.0,45.0
    };
    mavlink_kflow_horizontal_motion_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ox = packet_in.ox;
        packet1.oy = packet_in.oy;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_KFLOW_HORIZONTAL_MOTION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_KFLOW_HORIZONTAL_MOTION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_horizontal_motion_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_kflow_horizontal_motion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_horizontal_motion_pack(system_id, component_id, &msg , packet1.ox , packet1.oy );
    mavlink_msg_kflow_horizontal_motion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_horizontal_motion_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ox , packet1.oy );
    mavlink_msg_kflow_horizontal_motion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_kflow_horizontal_motion_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_horizontal_motion_send(MAVLINK_COMM_1 , packet1.ox , packet1.oy );
    mavlink_msg_kflow_horizontal_motion_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_motion_mode(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_MOTION_MODE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_motion_mode_t packet_in = {
        963497464
    };
    mavlink_mcu_motion_mode_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.motion_mode = packet_in.motion_mode;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_MOTION_MODE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_MOTION_MODE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_motion_mode_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_motion_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_motion_mode_pack(system_id, component_id, &msg , packet1.motion_mode );
    mavlink_msg_mcu_motion_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_motion_mode_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.motion_mode );
    mavlink_msg_mcu_motion_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_motion_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_motion_mode_send(MAVLINK_COMM_1 , packet1.motion_mode );
    mavlink_msg_mcu_motion_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_kflow_gimbal_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_KFLOW_GIMBAL_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_kflow_gimbal_status_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0
    };
    mavlink_kflow_gimbal_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pitch = packet_in.pitch;
        packet1.roll = packet_in.roll;
        packet1.yaw = packet_in.yaw;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_KFLOW_GIMBAL_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_KFLOW_GIMBAL_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_gimbal_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_kflow_gimbal_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_gimbal_status_pack(system_id, component_id, &msg , packet1.pitch , packet1.roll , packet1.yaw , packet1.gyrox , packet1.gyroy , packet1.gyroz );
    mavlink_msg_kflow_gimbal_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_gimbal_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pitch , packet1.roll , packet1.yaw , packet1.gyrox , packet1.gyroy , packet1.gyroz );
    mavlink_msg_kflow_gimbal_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_kflow_gimbal_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kflow_gimbal_status_send(MAVLINK_COMM_1 , packet1.pitch , packet1.roll , packet1.yaw , packet1.gyrox , packet1.gyroy , packet1.gyroz );
    mavlink_msg_kflow_gimbal_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_localizer_ready(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_LOCALIZER_READY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_localizer_ready_t packet_in = {
        5
    };
    mavlink_mcu_localizer_ready_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.localizer_ready = packet_in.localizer_ready;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_LOCALIZER_READY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_LOCALIZER_READY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_localizer_ready_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_localizer_ready_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_localizer_ready_pack(system_id, component_id, &msg , packet1.localizer_ready );
    mavlink_msg_mcu_localizer_ready_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_localizer_ready_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.localizer_ready );
    mavlink_msg_mcu_localizer_ready_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_localizer_ready_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_localizer_ready_send(MAVLINK_COMM_1 , packet1.localizer_ready );
    mavlink_msg_mcu_localizer_ready_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gps_raw_ground_truth(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GPS_RAW_GROUND_TRUTH >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gps_raw_ground_truth_t packet_in = {
        93372036854775807ULL,963497880,963498088,963498296,18275,18379,18483,18587,89,156,963499024,963499232,963499440,963499648,963499856
    };
    mavlink_gps_raw_ground_truth_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GPS_RAW_GROUND_TRUTH_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GPS_RAW_GROUND_TRUTH_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_raw_ground_truth_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gps_raw_ground_truth_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_raw_ground_truth_pack(system_id, component_id, &msg , packet1.time_usec , packet1.fix_type , packet1.lat , packet1.lon , packet1.alt , packet1.eph , packet1.epv , packet1.vel , packet1.cog , packet1.satellites_visible , packet1.alt_ellipsoid , packet1.h_acc , packet1.v_acc , packet1.vel_acc , packet1.hdg_acc );
    mavlink_msg_gps_raw_ground_truth_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_raw_ground_truth_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.fix_type , packet1.lat , packet1.lon , packet1.alt , packet1.eph , packet1.epv , packet1.vel , packet1.cog , packet1.satellites_visible , packet1.alt_ellipsoid , packet1.h_acc , packet1.v_acc , packet1.vel_acc , packet1.hdg_acc );
    mavlink_msg_gps_raw_ground_truth_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gps_raw_ground_truth_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_raw_ground_truth_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.fix_type , packet1.lat , packet1.lon , packet1.alt , packet1.eph , packet1.epv , packet1.vel , packet1.cog , packet1.satellites_visible , packet1.alt_ellipsoid , packet1.h_acc , packet1.v_acc , packet1.vel_acc , packet1.hdg_acc );
    mavlink_msg_gps_raw_ground_truth_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mcu_ready_to_go(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MCU_READY_TO_GO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mcu_ready_to_go_t packet_in = {
        5
    };
    mavlink_mcu_ready_to_go_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.mcu_ready = packet_in.mcu_ready;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MCU_READY_TO_GO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MCU_READY_TO_GO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_ready_to_go_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mcu_ready_to_go_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_ready_to_go_pack(system_id, component_id, &msg , packet1.mcu_ready );
    mavlink_msg_mcu_ready_to_go_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_ready_to_go_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mcu_ready );
    mavlink_msg_mcu_ready_to_go_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mcu_ready_to_go_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mcu_ready_to_go_send(MAVLINK_COMM_1 , packet1.mcu_ready );
    mavlink_msg_mcu_ready_to_go_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_kgeo_to_mcu_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_KGEO_TO_MCU_HEARTBEAT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_kgeo_to_mcu_heartbeat_t packet_in = {
        5
    };
    mavlink_kgeo_to_mcu_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.is_alive = packet_in.is_alive;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_KGEO_TO_MCU_HEARTBEAT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_KGEO_TO_MCU_HEARTBEAT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kgeo_to_mcu_heartbeat_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_kgeo_to_mcu_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kgeo_to_mcu_heartbeat_pack(system_id, component_id, &msg , packet1.is_alive );
    mavlink_msg_kgeo_to_mcu_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kgeo_to_mcu_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.is_alive );
    mavlink_msg_kgeo_to_mcu_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_kgeo_to_mcu_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kgeo_to_mcu_heartbeat_send(MAVLINK_COMM_1 , packet1.is_alive );
    mavlink_msg_kgeo_to_mcu_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_gcs_to_mcu_select_target(system_id, component_id, last_msg);
    mavlink_test_vision_operating_mode_info(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_zoom_control(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_gimbal_control(system_id, component_id, last_msg);
    mavlink_test_mcu_to_gcs_pod_status(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_steer_control(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_command(system_id, component_id, last_msg);
    mavlink_test_mcu_to_gcs_heartbeat(system_id, component_id, last_msg);
    mavlink_test_add_update_waypoint(system_id, component_id, last_msg);
    mavlink_test_waypoint_update(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_go_to_location(system_id, component_id, last_msg);
    mavlink_test_as5048a_magnetic_rotary_encoder(system_id, component_id, last_msg);
    mavlink_test_mcu_to_ap_system_status(system_id, component_id, last_msg);
    mavlink_test_ap_to_mcu_emergency_status(system_id, component_id, last_msg);
    mavlink_test_mcu_start_mission_status(system_id, component_id, last_msg);
    mavlink_test_update_mission_plan_params(system_id, component_id, last_msg);
    mavlink_test_set_vision_function_enabled(system_id, component_id, last_msg);
    mavlink_test_start_update_platform_shift(system_id, component_id, last_msg);
    mavlink_test_save_update_image(system_id, component_id, last_msg);
    mavlink_test_gcs_to_mcu_gimbal_motor_command(system_id, component_id, last_msg);
    mavlink_test_gcs_position(system_id, component_id, last_msg);
    mavlink_test_other_platform_position(system_id, component_id, last_msg);
    mavlink_test_mcu_to_gcs_command_error(system_id, component_id, last_msg);
    mavlink_test_add_flight_point(system_id, component_id, last_msg);
    mavlink_test_kflow_horizontal_motion(system_id, component_id, last_msg);
    mavlink_test_mcu_motion_mode(system_id, component_id, last_msg);
    mavlink_test_kflow_gimbal_status(system_id, component_id, last_msg);
    mavlink_test_mcu_localizer_ready(system_id, component_id, last_msg);
    mavlink_test_gps_raw_ground_truth(system_id, component_id, last_msg);
    mavlink_test_mcu_ready_to_go(system_id, component_id, last_msg);
    mavlink_test_kgeo_to_mcu_heartbeat(system_id, component_id, last_msg);
