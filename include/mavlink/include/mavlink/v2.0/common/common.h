...
/** @brief Flags in MCU_TO_GCS_HEARTBEAT message */
#ifndef HAVE_ENUM_MCU_TO_GCS_STATUS_FLAGS
#define HAVE_ENUM_MCU_TO_GCS_STATUS_FLAGS
typedef enum MCU_TO_GCS_STATUS_FLAGS
{
   MISSION_MODE_FLAG=1, /*  Indicates mission mode enabled.  | */
   MANUAL_MODE_FLAG=2, /*  Indicates manual mode is enabled.  | */
   FOLLOW_GCS_FLAG=4, /*  Indicates follow GCS function is activated.  | */
   FOLLOW_TARGET_FLAG=8, /*  Indicates follow target function is activated.  | */
   SECTOR_SCAN_FLAG=16, /*  Indicates sector scanning function is activated.  | */
   IN_USER_JOYSTICK_CONTROL_FLAG=32, /*  Indicates drone is controllable via joystick.  | */
   VISION_TARGET_TRACKING_FLAG=64, /*  Indicates vision target tracking is enabled.  | */
   VISION_MOVING_OBJECT_DETECTION_FLAG=128, /*  Indicates vision moving object detection is enabled.  | */
   VISION_OBJECT_CLASSIFICATION_FLAG=256, /*  Indicates vision object classification is enabled.  | */
   VISION_STABILIZATION_FLAG=512, /*  Indicates vision stabilization is enabled.  | */
   RETURNING_TO_HOME_FLAG=1024, /*  Indicates that the platform is now returning to home.  | */
   TAKING_OFF_FLAG=2048, /*  Indicates that the platform is now taking off.  | */
   NAVIGATING_TO_WAYPOINT_FLAG=4096, /*  Indicates that the platform is navigating to waypoint.  | */
   PRIMARY_PLATFORM_FLAG=8192, /*  Indicates that current platform is the primary platform.  | */
   SECONDARY_PLATFORM_FLAG=16384, /*  Indicates that current platform is the secondary platform.  | */
   READY_TO_SHIFT_PLATFORM_FLAG=32768, /*  Indicates that platform is ready to shift.  | */
   PLATFORM_SHIFT_ACTIVATED_FLAG=65536, /*  Indicates platform shift function is activated.  | */
   ARRIVED_PRIMARY_PLATFORM_LOCATION_FLAG=131072, /*  Indicates that secondary platform is arrived the location of the primary platform while platform shift.  | */
   PAUSED_MISSION_MODE_FLAG=262144, /*  Indicates that mission mode is paused.  | */
   USER_JOYSTICK_INPUT_PROCESSED_FLAG=524288, /*  Indicates drone is being controlled via joystick.  | */
   MCU_TO_GCS_STATUS_FLAGS_ENUM_END=524289, /*  | */
} MCU_TO_GCS_STATUS_FLAGS;
#endif

/** @brief  Type of KERKES flight points  */
#ifndef HAVE_ENUM_FLIGHT_POINT_TYPE
#define HAVE_ENUM_FLIGHT_POINT_TYPE
typedef enum FLIGHT_POINT_TYPE
{
   TARGET_POINT=0, /*  | */
   LAND_POINT=1, /*  | */
   FLIGHT_POINT_TYPE_ENUM_END=2, /*  | */
} FLIGHT_POINT_TYPE;
#endif

/** @brief  Defines KERKES mission modes  */
#ifndef HAVE_ENUM_KERKES_MODE_TYPE
#define HAVE_ENUM_KERKES_MODE_TYPE
typedef enum KERKES_MODE_TYPE
{
   KERKES_MODE_NONE=0, /*  | */
   KERKES_MANUAL_MODE=1, /*  | */
   KERKES_TRACKING_MODE=2, /*  | */
   KERKES_LANDMARK_MODE=3, /*  | */
   KERKES_ORTHOPHOTO_MODE=4, /*  | */
   KERKES_MODE_TYPE_ENUM_END=5, /*  | */
} KERKES_MODE_TYPE;
#endif

/** @brief  Defines start mission status types  */
#ifndef HAVE_ENUM_START_MISSION_STATUS_TYPE
#define HAVE_ENUM_START_MISSION_STATUS_TYPE
typedef enum START_MISSION_STATUS_TYPE
{
   MISSION_STATUS_STARTED=0, /*  | */
   MISSION_STATUS_ERROR_NO_PLAN_LOADED=1, /*  | */
   MISSION_STATUS_NOT_READY_TO_FLY=2, /*  | */
   MISSION_STATUS_UNDEFINED_ERROR=3, /*  | */
   START_MISSION_STATUS_TYPE_ENUM_END=4, /*  | */
} START_MISSION_STATUS_TYPE;
#endif

/** @brief  Defines TOGAN waypoint types  */
#ifndef HAVE_ENUM_MISSION_WAYPOINT_TYPE
#define HAVE_ENUM_MISSION_WAYPOINT_TYPE
typedef enum MISSION_WAYPOINT_TYPE
{
   MISSION_WAYPOINT_NONE=0, /*  | */
   MISSION_WAYPOINT_ORDINARY=1, /*  | */
   MISSION_WAYPOINT_RTL_POINT=2, /*  | */
   MISSION_WAYPOINT_TYPE_ENUM_END=3, /*  | */
} MISSION_WAYPOINT_TYPE;
#endif

/** @brief  Defines TOGAN mission modes  */
#ifndef HAVE_ENUM_TOGAN_CAMERA_TYPE
#define HAVE_ENUM_TOGAN_CAMERA_TYPE
typedef enum TOGAN_CAMERA_TYPE
{
   TOGAN_CAMERA_NONE=0, /*  | */
   ELECTRO_OPTIC_CAMERA=1, /*  | */
   THERMAL_CAMERA=2, /*  | */
   TOGAN_CAMERA_TYPE_ENUM_END=3, /*  | */
} TOGAN_CAMERA_TYPE;
#endif

/** @brief  Defines GCS to MCU command types  */
#ifndef HAVE_ENUM_GCS_TO_MCU_COMMAND_TYPE
#define HAVE_ENUM_GCS_TO_MCU_COMMAND_TYPE
typedef enum GCS_TO_MCU_COMMAND_TYPE
{
   GCS_CMD_LOAD_MISSION_PLAN=0, /*  | */
   GCS_CMD_REQUEST_MISSION_PLAN=1, /*  | */
   GCS_CMD_GEOFENCE_RADIUS=2, /*  | */
   GCS_CMD_DELETE_WAYPOINT=3, /*  | */
   GCS_CMD_RETURN_TO_HOME=4, /*  | */
   GCS_CMD_MANUAL_MODE=5, /*  | */
   GCS_CMD_SECTOR_SCANNING=6, /*  | */
   GCS_CMD_FOLLOW_GCS=7, /*  | */
   GCS_CMD_FOLLOW_TARGET=8, /*  | */
   GCS_CMD_RESUME_MISSION=9, /*  | */
   GCS_CMD_SET_MISSION_ALTITUDE=10, /*  | */
   GCS_CMD_STOP=11, /*  | */
   GCS_CMD_START_MISSION=12, /*  | */
   GCS_CMD_SELECT_CAMERA=13, /*  | */
   GCS_CMD_GCS_HEARTBEAT=14, /*  | */
   GCS_CMD_DESELECT_TARGET=15, /*  | */
   GCS_CMD_SET_CRUISE_SPEED=16, /*  | */
   GCS_CMD_BE_READY_TO_SHIFT_PLATFORM=17, /*  | */
   GCS_CMD_CANCEL_PLATFORM_SHIFT=18, /*  | */
   GCS_CMD_FINALIZE_PLATFORM_SHIFT=19, /*  | */
   GCS_CMD_PAUSE_MISSION=20, /*  | */
   GCS_CMD_OTHER_PLATFORM_ALIVE=21, /*  | */
   GCS_CMD_PLATFORM_CATEGORY=22, /*  | */
   GCS_CMD_LAND=23, /*  | */
   GCS_CMD_SET_KERKES_MISSION_TYPE=24, /*  | */
   GCS_CMD_SET_MISSION_TERMINATE_ACTION=25, /*  | */
   GCS_CMD_SET_LOW_BATTERY_EA=26, /*  | */
   GCS_CMD_SET_SENSOR_FAILURE_EA=27, /*  | */
   GCS_CMD_SET_CAMERA_FAILURE_EA=28, /*  | */
   GCS_CMD_SET_LINK_LOSS_EA=29, /*  | */
   GCS_CMD_SET_CURRENT_EA=30, /*  | */
   GCS_CMD_SWITCH_VIDEO=31, /*  | */
   GCS_TO_MCU_COMMAND_TYPE_ENUM_END=32, /*  | */
} GCS_TO_MCU_COMMAND_TYPE;
#endif

/** @brief  Defines KERKES mission terminate action  */
#ifndef HAVE_ENUM_KERKES_MISSION_TERMINATE_ACTION
#define HAVE_ENUM_KERKES_MISSION_TERMINATE_ACTION
typedef enum KERKES_MISSION_TERMINATE_ACTION
{
   KERKES_MISSION_TERMINATE_NOACTION=0, /*  | */
   KERKES_MISSION_TERMINATE_WAIT=1, /*  | */
   KERKES_MISSION_TERMINATE_LAND=2, /*  | */
   KERKES_MISSION_TERMINATE_ACTION_ENUM_END=3, /*  | */
} KERKES_MISSION_TERMINATE_ACTION;
#endif

/** @brief  Defines KERKES mission type  */
#ifndef HAVE_ENUM_KERKES_MISSION_TYPE
#define HAVE_ENUM_KERKES_MISSION_TYPE
typedef enum KERKES_MISSION_TYPE
{
   KERKES_MISSION_DAY=0, /*  | */
   KERKES_MISSION_NIGHT=1, /*  | */
   KERKES_MISSION_TYPE_ENUM_END=2, /*  | */
} KERKES_MISSION_TYPE;
#endif

/** @brief  Defines vision-engine functions  */
#ifndef HAVE_ENUM_VISION_FUNCTION_TYPE
#define HAVE_ENUM_VISION_FUNCTION_TYPE
typedef enum VISION_FUNCTION_TYPE
{
   VISION_FUNCTION_STABILIZATION=0, /*  | */
   VISION_FUNCTION_NAVIGATION=1, /*  | */
   VISION_FUNCTION_MOVING_OBJECT_DETECTION=2, /*  | */
   VISION_FUNCTION_OBJECT_CLASSIFICATION=3, /*  | */
   VISION_FUNCTION_TYPE_ENUM_END=4, /*  | */
} VISION_FUNCTION_TYPE;
#endif

/** @brief  Defines vision-engine functions  */
#ifndef HAVE_ENUM_VISION_OPERATING_MODE_TYPE
#define HAVE_ENUM_VISION_OPERATING_MODE_TYPE
typedef enum VISION_OPERATING_MODE_TYPE
{
   VISION_OPERATING_MODE_IDLE=0, /*  | */
   VISION_OPERATING_MODE_IDLE_TRACKING_TARGET_LOST=1, /*  | */
   VISION_OPERATING_MODE_TRACKING=2, /*  | */
   VISION_OPERATING_MODE_MOVING_OBJECT_DETECTION=3, /*  | */
   VISION_OPERATING_MODE_OBJECT_CLASSIFICATION=4, /*  | */
   VISION_OPERATING_MODE_STABILIZATION=5, /*  | */
   VISION_OPERATING_MODE_TYPE_ENUM_END=6, /*  | */
} VISION_OPERATING_MODE_TYPE;
#endif

/** @brief  Defines emergency reason  */
#ifndef HAVE_ENUM_AP_EMERGENCY_REASON
#define HAVE_ENUM_AP_EMERGENCY_REASON
typedef enum AP_EMERGENCY_REASON
{
   REASON_MASK_GPS_GLITCH=1, /*  | */
   REASON_MASK_ALTITUDE_DRIFT=2, /*  | */
   REASON_MASK_COMPASS_DRIFT=4, /*  | */
   REASON_MASK_CRITICAL_BATTERY=8, /*  | */
   REASON_MASK_MCU_LINK_LOSS=16, /*  | */
   REASON_MASK_GCS_LINK_LOSS=32, /*  | */
   REASON_MASK_POD_FAIL=64, /*  | */
   REASON_MASK_SENSORS_FAIL=128, /*  | */
   AP_EMERGENCY_REASON_ENUM_END=129, /*  | */
} AP_EMERGENCY_REASON;
#endif

/** @brief  Defines emergency action  */
#ifndef HAVE_ENUM_AP_EMERGENCY_ACTION
#define HAVE_ENUM_AP_EMERGENCY_ACTION
typedef enum AP_EMERGENCY_ACTION
{
   ACTION_NA=0, /*  | */
   ACTION_STAY_ON_GROUND=1, /*  | */
   ACTION_CLIMBING_SAFE_ALT=2, /*  | */
   ACTION_CLIMBED_SAFE_ALT=3, /*  | */
   ACTION_PAUSE=4, /*  | */
   ACTION_SELF_DESTRUCT=5, /*  | */
   AP_EMERGENCY_ACTION_ENUM_END=6, /*  | */
} AP_EMERGENCY_ACTION;
#endif

/** @brief  Defines emergency sensor health  */
#ifndef HAVE_ENUM_AP_EMERGENCY_SENSOR_HEALTH
#define HAVE_ENUM_AP_EMERGENCY_SENSOR_HEALTH
typedef enum AP_EMERGENCY_SENSOR_HEALTH
{
   SENSOR_HEALTH_MASK_ACC_PRESENT=1, /*  | */
   SENSOR_HEALTH_MASK_ACC_HEALTHY=2, /*  | */
   SENSOR_HEALTH_MASK_GYRO_PRESENT=4, /*  | */
   SENSOR_HEALTH_MASK_GYRO_HEALTHY=8, /*  | */
   SENSOR_HEALTH_MASK_MAG_PRESENT=16, /*  | */
   SENSOR_HEALTH_MASK_MAG_HEALTHY=32, /*  | */
   SENSOR_HEALTH_MASK_DISTANCE_SENSOR_PRESENT=64, /*  | */
   SENSOR_HEALTH_MASK_DISTANCE_SENSOR_HEALTHY=128, /*  | */
   SENSOR_HEALTH_MASK_OPTICALFLOW_PRESENT=256, /*  | */
   SENSOR_HEALTH_MASK_OPTICALFLOW_HEALTHY=512, /*  | */
   SENSOR_HEALTH_MASK_GPS_PRESENT=1024, /*  | */
   SENSOR_HEALTH_MASK_GPS_HEALTHY=2048, /*  | */
   SENSOR_HEALTH_MASK_ABSPRESSURE_PRESENT=4096, /*  | */
   SENSOR_HEALTH_MASK_ABSPRESSURE_HEALTHY=8192, /*  | */
   SENSOR_HEALTH_MASK_AHRS_PRESENT=16384, /*  | */
   SENSOR_HEALTH_MASK_AHRS_HEALTHY=32768, /*  | */
   AP_EMERGENCY_SENSOR_HEALTH_ENUM_END=32769, /*  | */
} AP_EMERGENCY_SENSOR_HEALTH;
#endif

/** @brief  Defines MCU system status  */
#ifndef HAVE_ENUM_MCU_SYSTEM_STATUS
#define HAVE_ENUM_MCU_SYSTEM_STATUS
typedef enum MCU_SYSTEM_STATUS
{
   MCU_GCS_LINK_FAIL=1, /*  | */
   MCU_POD_FAIL=2, /*  | */
   MCU_SYSTEM_STATUS_ENUM_END=3, /*  | */
} MCU_SYSTEM_STATUS;
#endif

/** @brief Enumeration of possible gimbal motor command types */
#ifndef HAVE_ENUM_GIMBAL_MOTOR_COMMAND_TYPE
#define HAVE_ENUM_GIMBAL_MOTOR_COMMAND_TYPE
typedef enum GIMBAL_MOTOR_COMMAND_TYPE
{
   GIMBAL_MOTOR_COMMAND_TYPE_MOTOR_OFF=0, /* Gimbal motor command for motor off | */
   GIMBAL_MOTOR_COMMAND_TYPE_MOTOR_ON=1, /* Gimbal motor command for motor on | */
   GIMBAL_MOTOR_COMMAND_TYPE_ENUM_END=2, /*  | */
} GIMBAL_MOTOR_COMMAND_TYPE;
#endif

/** @brief  Defines MCU motion mode  */
#ifndef HAVE_ENUM_MCU_MOTION_MODE_TYPE
#define HAVE_ENUM_MCU_MOTION_MODE_TYPE
typedef enum MCU_MOTION_MODE_TYPE
{
   MCU_MOTION_MODE_NONE=0, /*  | */
   MCU_MOTION_MODE_HOVER=1, /*  | */
   MCU_MOTION_MODE_ASCEND=2, /*  | */
   MCU_MOTION_MODE_DESCEND=3, /*  | */
   MCU_MOTION_MODE_MOVEMENT=4, /*  | */
   MCU_MOTION_MODE_TYPE_ENUM_END=5, /*  | */
} MCU_MOTION_MODE_TYPE;
#endif

/** @brief  Defines MCU motion mode  */
#ifndef HAVE_ENUM_KERKES_EMERGENY_ACTION_TYPE
#define HAVE_ENUM_KERKES_EMERGENY_ACTION_TYPE
typedef enum KERKES_EMERGENY_ACTION_TYPE
{
   KERKES_EMERGENCY_ACTION_NA=0, /*  | */
   KERKES_EMERGENCY_ACTION_NONE=1, /*  | */
   KERKES_EMERGENCY_ACTION_WAIT=2, /*  | */
   KERKES_EMERGENCY_ACTION_RTL=3, /*  | */
   KERKES_EMERGENCY_ACTION_LAND=4, /*  | */
   KERKES_EMERGENCY_ACTION_KILL=5, /*  | */
   KERKES_EMERGENY_ACTION_TYPE_ENUM_END=6, /*  | */
} KERKES_EMERGENY_ACTION_TYPE;
#endif
...
#include "./mavlink_msg_gcs_to_mcu_select_target.h"
#include "./mavlink_msg_vision_operating_mode_info.h"
#include "./mavlink_msg_gcs_to_mcu_zoom_control.h"
#include "./mavlink_msg_gcs_to_mcu_gimbal_control.h"
#include "./mavlink_msg_mcu_to_gcs_pod_status.h"
#include "./mavlink_msg_gcs_to_mcu_steer_control.h"
#include "./mavlink_msg_gcs_to_mcu_command.h"
#include "./mavlink_msg_mcu_to_gcs_heartbeat.h"
#include "./mavlink_msg_add_update_waypoint.h"
#include "./mavlink_msg_waypoint_update.h"
#include "./mavlink_msg_gcs_to_mcu_go_to_location.h"
#include "./mavlink_msg_as5048a_magnetic_rotary_encoder.h"
#include "./mavlink_msg_mcu_to_ap_system_status.h"
#include "./mavlink_msg_ap_to_mcu_emergency_status.h"
#include "./mavlink_msg_mcu_start_mission_status.h"
#include "./mavlink_msg_update_mission_plan_params.h"
#include "./mavlink_msg_set_vision_function_enabled.h"
#include "./mavlink_msg_start_update_platform_shift.h"
#include "./mavlink_msg_save_update_image.h"
#include "./mavlink_msg_gcs_to_mcu_gimbal_motor_command.h"
#include "./mavlink_msg_gcs_position.h"
#include "./mavlink_msg_other_platform_position.h"
#include "./mavlink_msg_mcu_to_gcs_command_error.h"
#include "./mavlink_msg_add_flight_point.h"
#include "./mavlink_msg_kflow_horizontal_motion.h"
#include "./mavlink_msg_mcu_motion_mode.h"
#include "./mavlink_msg_kflow_gimbal_status.h"
#include "./mavlink_msg_mcu_localizer_ready.h"
#include "./mavlink_msg_gps_raw_ground_truth.h"
#include "./mavlink_msg_mcu_ready_to_go.h"
#include "./mavlink_msg_kgeo_to_mcu_heartbeat.h"
